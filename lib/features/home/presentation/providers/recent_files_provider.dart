...
class RecentFilesProvider extends InheritedNotifier<RecentFilesService> {
  const RecentFilesProvider({
    super.key,
    required RecentFilesService service,
    required super.child,
  }) : super(notifier: service);

  static RecentFilesService of(BuildContext context) {
    final provider = context
        .dependOnInheritedWidgetOfExactType<RecentFilesProvider>();
