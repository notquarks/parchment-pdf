...
/* Create a job from options. Returns NULL on allocation failure.
   The job owns a copy of *options; the caller may free options after this. */
QPDF_OPTIMIZER_EXPORT qpdf_optimizer_job* qpdf_optimizer_create_job(
